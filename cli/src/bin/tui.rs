    ...
    'mainloop: loop {
        ...
        terminal.draw(|f| {
            ...
            match tab_index {
                ...
                3 => {
                    let help = Paragraph::new("RAG Chat: Use CLI 'chimera chat --query \"your question\"' for conversational log analysis")
                        .block(Block::default().borders(Borders::ALL).title("RAG Chat"));
                    f.render_widget(help, chunks[1]);
                }
                _ => {
